...
class PDF extends FPDF
{
    ...
    function Header()
    {
      ...
      $this->Image('../../assets/img/logo-jakbar.jpg',20,10);
        ...
        $this->Cell(200,8,'KEL. SEMPLAK, KEC. BOGOR BARAT',0,1,'C');
    	$this->Cell(200,8,'KOTA BOGOR',0,1,'C');
    	// Line break
    	$this->Ln(5);
    ...
    function Footer()
    {
    	...
    	$this->SetFont('Arial','I',8);
    	// Page number
    	$this->Cell(30,60,'TTD & Cap Pengurus RT, ');
        //$this->Cell(60,110,'Tholib ');
    }
}
...
$nomor = 1;
    ...
    $pdf->cell(2,7,':',0,0,'L');
    $pdf->cell(80, 7, substr(strtoupper($data_warga[0]['nama_warga']),0 , 32), 0, 1, 'L');
